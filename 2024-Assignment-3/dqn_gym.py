...
# Adapted from PyTorch Tutorial: Reinforcement Q-Learning
# URL: https://pytorch.org/tutorials/intermediate/reinforcement_q_learning.html
is_ipython = 'inline' in matplotlib.get_backend()
if is_ipython:
    from IPython import display

# Function that activly plots the R100 score against the episodes
# Adapted from PyTorch Tutorial: Reinforcement Q-Learning
# URL: https://pytorch.org/tutorials/intermediate/reinforcement_q_learning.html
def plot_R100(episodeList, r100List, show_result=False):
    plt.figure(1)
    ...
    plt.xlabel('Episode')
    plt.ylabel('R100')
    plt.plot(episodes_t.numpy(), rewards_t.numpy())
    plt.pause(0.001) 
...
while True:
    ...
    if is_done:
        ...
        episodeList.append(episode_no)
        r100List.append(r100)
        plot_R100(episodeList, r100List)
